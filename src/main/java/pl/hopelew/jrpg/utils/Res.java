...
public enum Res {
	...
	HERO_SPRITE_MALE("/img/hero/sprites/m_40", ResType.SPRITE, 64),;
	// HERO_SPRITE_FEMALE("/img/hero/sprites/f_06", ResType.SPRITE, 64);
	...
	private Res(String path, ResType type, int resolution) {
		this(path, type);
